...
*/5 * * * * cd /home/dozo/Sources/hermes-integrations && bash scripts/post-pi-agent.sh >> logs/post-pi-agent.log 2>&1
00 */4 * * *  cd /home/dozo/Sources/hermes-integrations && bash scripts/post-pi-agent.sh >> logs/post-pi-agent.log 2>&1
